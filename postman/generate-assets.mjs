...
const e2eCollection = {
  ...
  item: [
    folder("Auth & Webhook", [
      requestItem({
        name: "01. Clerk - Start Sign In",
        method: "POST",
        url: "{{clerk_frontend_api_url}}/v1/client/sign_ins",
        auth: noauth,
        headers: formHeader(),
        body: {
          mode: "raw",
          raw: "identifier={{clerk_email}}",
        },
        prerequest: `
          ["clerk_frontend_api_url", "clerk_email", "clerk_password"].forEach(function (key) {
        ...
        `,
        test: `
          pm.test("clerk sign-in start returns success", function () {
            pm.expect([200, 201]).to.include(pm.response.code);
          });
          var json = pm.response.json();
          var payload = json.response || json;
          var signInId = payload.id || "";
          pm.test("clerk sign-in id is present", function () {
            pm.expect(signInId).to.not.eql("");
          });
          pm.environment.set("clerk_sign_in_id", signInId);
        `,
      }),
      requestItem({
        name: "02. Clerk - Attempt Password",
        method: "POST",
        url: "{{clerk_frontend_api_url}}/v1/client/sign_ins/{{clerk_sign_in_id}}/attempt_first_factor",
        auth: noauth,
        headers: formHeader(),
        body: {
          mode: "raw",
          raw: "strategy=password&password={{clerk_password}}",
        },
        test: `
      ...
      requestItem({
        name: "03. Clerk - Read Client Session",
        method: "GET",
        url: "{{clerk_frontend_api_url}}/v1/client",
        auth: noauth,
        test: `
      ...
      requestItem({
        name: "04. Webhook - Signed user.created",
        method: "POST",
        url: "{{base_url}}/webhooks/clerk",
        auth: noauth,
        headers: jsonHeader(),
      ...
      requestItem({
        name: "05. Webhook - Invalid Signature",
        method: "POST",
        url: "{{base_url}}/webhooks/clerk",
        auth: noauth,
        headers: jsonHeader(),
    ...
    folder("Documents & AI", [
      ...
      requestItem({
        name: "10. Documents - Patch Primary",
        method: "PATCH",
        url: "{{base_url}}/v1/documents/{{document_id_primary}}",
        headers: jsonHeader(),
        body: {
      ...
      requestItem({
        name: "12A. Documents - Archive Bootstrap",
        method: "POST",
      ...
      requestItem({
        name: "13. Documents - Save Content",
        method: "PUT",
      ...
      requestItem({
        name: "16. AI - Generate Proposal For Apply",
        method: "POST",
      ...
      requestItem({
        name: "18. AI - Generate Proposal For Dismiss",
        method: "POST",
        url: "{{base_url}}/v1/documents/{{document_id_primary}}/ai/proposals",
        headers: jsonHeader(),
        body: {
    ...
    folder("Sources & Exports", [
      requestItem({
        name: "20. Sources - Create Upload URL",
        method: "POST",
      ...
      requestItem({
        name: "21. Sources - Upload Sample PDF",
        method: "PUT",
        url: "{{upload_url}}",
        auth: noauth,
        headers: [
      ...
      requestItem({
        name: "23. Sources - List For Document",
        method: "GET",
      ...
      requestItem({
        ...
        test: `
          ...
          if ((status === "queued" || status === "processing") && attempt < maxAttempts) {
            postman.setNextRequest("24. Sources - Get Status");
          } else if (status === "failed") {
            postman.setNextRequest("25. Sources - Retry If Failed");
          } else {
            postman.setNextRequest("26. Exports - Preflight");
          }
        `,
      }),
      requestItem({
        name: "25. Sources - Retry If Failed",
        method: "POST",
      ...
      requestItem({
        name: "27. Exports - Queue DOCX Export",
        method: "POST",
      ...
      requestItem({
        ...
        test: `
          ...
          if ((status === "queued" || status === "processing") && attempt < maxAttempts) {
            postman.setNextRequest("29. Exports - Get Status");
          } else if (status === "ready") {
            postman.setNextRequest("30. Exports - Download If Ready");
          } else if (status === "failed") {
            postman.setNextRequest("31. Exports - Retry If Failed");
          } else {
            postman.setNextRequest("32. Sources - Delete");
          }
        `,
      }),
      requestItem({
        name: "30. Exports - Download If Ready",
        method: "GET",
      ...
      requestItem({
        name: "31. Exports - Retry If Failed",
        method: "POST",
      ...
      requestItem({
        ...
        test: `
          ...
          postman.setNextRequest("33. Cleanup - Delete Bootstrap Document");
        `,
      }),
      requestItem({
        name: "33. Cleanup - Delete Bootstrap Document",
        method: "DELETE",
        ...
        test: `
          ...
          postman.setNextRequest("34. Cleanup - Delete Primary Document");
        `,
      }),
      requestItem({
        name: "34. Cleanup - Delete Primary Document",
        method: "DELETE",
        url: "{{base_url}}/v1/documents/{{document_id_primary}}",
        test: `
