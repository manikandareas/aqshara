...
export function getToolbarTooltipTriggerProps(
  trigger: React.ReactElement,
  tooltipTriggerProps?: React.ComponentPropsWithoutRef<typeof TooltipTrigger>
) {
  if (tooltipTriggerProps?.render) {
    return tooltipTriggerProps;
  }
    ...
    if (tooltip && mounted) {
      return (
        <Tooltip {...tooltipProps}>
          <TooltipTrigger
            {...getToolbarTooltipTriggerProps(component, tooltipTriggerProps)}
          />
